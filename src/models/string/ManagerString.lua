require('game_cats.src.models.string.EStringType')
...
--    language[EStringType.EST_POPUP_NO_RESOURCE_BUTTON_CLOSE]  = 'CLOSE'
    ...
    --game over
    language[EStringType.EST_POPUP_GAME_OVER_BUTTON_CLOSE]  = 'NEXT'

    language[EStringType.EST_POPUP_GAME_OVER_TITLE]         = 'GAME OVER'
    
    --win
    language[EStringType.EST_POPUP_WIN_TITLE]               = 'GAME OVER!'
    ...
    language[EStringType.EST_POPUP_SHOP_BUTTON_PURCHASE]    = 'LIFES'
    language[EStringType.EST_POPUP_SHOP_BUTTON_ENERGY]      = 'BONUSES'
